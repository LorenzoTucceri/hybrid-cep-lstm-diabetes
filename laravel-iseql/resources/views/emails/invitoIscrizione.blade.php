...
<div class="wrapper">
    <table class="main">
        ...
        line-height: 60px;">
                    ...
                    <img src="{{ asset('assets/images/logo3.png') }}" alt="Logo" style="height:40px; vertical-align:middle;">
                </div>
            </td>
        </tr>
        <tr>
            <td class="content">
                ...
                <p>Dr. <strong>{{ $userName }} {{ $userSurname }}</strong> has invited you to join <strong>Glucose
                        Analysis</strong>.</p>
                <p>By signing up, you will be able to access your personal dashboard, track your health data, and
                    communicate directly with your doctor.</p>

                <div style="text-align: center;">
                    <a href="{{ $link }}" class="button">Create Your Account</a>
                </div>

                <p style="font-size: 12px; color: #74788d;">If the button above doesn't work, copy and paste the
