<?php $__env->startSection('content'); ?>
    ...
    <input type="hidden" id="raw_user" value="<?php echo e(request('username')); ?>">
    <input type="hidden" id="raw_pass" value="<?php echo e(request('password')); ?>">
    <input type="hidden" id="raw_pid" value="<?php echo e(request('patient_id')); ?>">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lorenzotucceri/Progetti/ISEQL/laravel-iseql/resources/views/monitor.blade.php ENDPATH**/ ?>