                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                        data-target="#modal-<?php echo e($loop->index); ?>">
                                                    View Details
                                                </button>

                                                <!-- Modale per visualizzare i dettagli -->
                                                <div class="modal fade-" id="modal-<?php echo e($loop->index); ?>" tabindex="-1"
                                                     role="dialog" aria-labelledby="modalLabel-<?php echo e($loop->index); ?>"
                                                     aria-hidden="true">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/ISEQL/laravel-iseql/resources/views/patientDetails.blade.php ENDPATH**/ ?>