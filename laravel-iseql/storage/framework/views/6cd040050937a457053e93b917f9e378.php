                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center mt-4">
                                                <img src="<?php echo e(URL::asset('/assets/images/pattern/p_ts.png')); ?>" alt="Time Swing Pattern" class="img-fluid rounded" style="width: 300px; height: auto;">
                                ...
                                <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                                    <table class="table table-sm table-striped datatable-glycemic-swings">
                                        ...
                                        <?php $__currentLoopData = $data['time_swing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr><td><?php echo e($swing['day']); ?></td><td><?php echo e($swing['first_event']); ?></td><td><?php echo e($swing['second_event']); ?></td><td><?php echo e($swing['duration_time_swing']); ?></td></tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center mt-4">
                                                <img src="<?php echo e(URL::asset('/assets/images/pattern/p_tl.png')); ?>" alt="Too Long Glucose Anomalies Pattern" class="img-fluid rounded" style="width: 300px; height: auto;">
                                ...
                                <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                                    <table id="datatable-too-long-duration" class="table table-sm table-striped">
                                        ...
                                        <?php $__currentLoopData = $data['too_long_glucose_anomalies']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr><td><?php echo e($swing['day']); ?></td><td><?php echo e($swing['event']); ?></td><td><?php echo e($swing['duration']); ?></td></tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center mt-4">
                                                <img src="<?php echo e(URL::asset('/assets/images/pattern/p_tf.png')); ?>" alt="Too Frequent Glucose Anomalies Pattern" class="img-fluid rounded" style="width: 300px; height: auto;">
                                ...
                                <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                                    <table id="datatable-anomalous-frequency" class="table table-sm table-striped">
                                        ...
                                        <?php $__currentLoopData = $data['too_frequent_glucose_anomalies']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr><td><?php echo e($f['day']); ?></td><td><?php echo e($f['total_count']); ?></td><td><?php echo e($f['high_count']); ?></td><td><?php echo e($f['low_count']); ?></td></tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center mt-4">
                                                <img src="<?php echo e(URL::asset('/assets/images/pattern/p_tstf.png')); ?>" alt="Too Frequent Time Swings Pattern" class="img-fluid rounded" style="width: 300px; height: auto;">
                                    ...
                                    <table id="datatable-swings-followed-by-frequency" class="table table-sm table-striped">
                                        ...
                                        <?php $__currentLoopData = $data['too_frequent_time_swings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-<?php echo e($loop->index); ?>">Details</button>
                                                    <div class="modal fade" id="modal-<?php echo e($loop->index); ?>" tabindex="-1" aria-hidden="true"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Details</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body">
                                                                    <table id="datatable-too-frequent_time_swings_details-<?php echo e($loop->index); ?>" class="table table-bordered dt-responsive nowrap w-100">
                                                                        <thead><tr><th>Day</th><th>First</th><th>Second</th><th>Dur</th></tr></thead>
                                                                        <tbody><?php $__currentLoopData = $swing['Events']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <tr><td><?php echo e($event['Day']); ?></td><td><?php echo e($event['First event']); ?></td><td><?php echo e($event['Second event']); ?></td><td><?php echo e($event['Duration time swing']); ?></td></tr> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></tbody>
                                                                    </table>
                                                                </div></div></div></div>
                                                </td>
                                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center mt-4">
                                                <img src="<?php echo e(URL::asset('/assets/images/pattern/p_tstl.png')); ?>" alt="Time Swing With Too Long Glucose Anomalies Pattern" class="img-fluid rounded" style="width: 300px; height: auto;">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable-swings-followed-by-duration" class="table table-sm table-striped">
                                        ...
                                        <?php $__currentLoopData = $data['time_swing_with_too_long_glucose_anomalies']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr><td><?php echo e($swing['day']); ?></td><td><?php echo e($swing['first_event']); ?></td><td><?php echo e($swing['second_event']); ?></td><td><?php echo e($swing['duration_time_swing']); ?></td><td><?php echo e($swing['anomalous_durations']); ?></td></tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-sm table-striped">
                                        ...
                                        <?php $__currentLoopData = $data['too_frequent_extremely_time_swings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($swing['Number of Time Swings'] ?? 'N/A'); ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-outline-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#modal-ext-<?php echo e($loop->index); ?>">Details</button>
                                                    <div class="modal fade" id="modal-ext-<?php echo e($loop->index); ?>" tabindex="-1" aria-hidden="true"><div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Details</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div><div class="modal-body">
            ...
            document.addEventListener("DOMContentLoaded", function () {
                let timeSwingData = [
                        <?php $__currentLoopData = $data['time_swing_with_too_long_glucose_anomalies'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $swing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        ...
                        time_swing_type: "<?php echo e($swing['first_event']); ?> to <?php echo e($swing['second_event']); ?>",
                        event_type: "<?php echo e(strtolower($swing['first_event'])); ?>"
                    },
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ];
