                        ...
                        <div class="card-body pt-0" >
                            <div class="auth-logo" >
                                ...
                                <a href="index" class="auth-logo-dark" >
                                    <div class="avatar-md profile-user-wid mb-4" >
                                    <span class="avatar-title rounded-circle bg-light" >
                                        <img src="<?php echo e(URL::asset('/assets/images/logo3.png')); ?>" alt=""
                                             height="70">
                                    </span>
                                    </div>
                                </a>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/ISEQL/laravel-iseql/resources/views/auth/login.blade.php ENDPATH**/ ?>