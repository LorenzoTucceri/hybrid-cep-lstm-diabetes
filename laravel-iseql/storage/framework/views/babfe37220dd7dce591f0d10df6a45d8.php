                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" method="POST" action="<?php echo e(route('registerDoctor')); ?>">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                               value="<?php echo e(old('name')); ?>" id="name" name="name" autofocus placeholder="Enter name">
...
unset($__errorArgs, $__bag); ?>"
                                               value="<?php echo e(old('surname')); ?>" id="surname" name="surname" placeholder="Enter surname">
...
unset($__errorArgs, $__bag); ?>"
                                               value="<?php echo e(old('email')); ?>" id="useremail" name="email" placeholder="Enter email">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-primary fw-medium"> Login </a> </p>
                                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lorenzotucceri/Progetti/ISEQL/laravel-iseql/resources/views/auth/register_doctor.blade.php ENDPATH**/ ?>