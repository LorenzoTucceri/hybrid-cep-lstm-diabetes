                        ...
                        <div class="bg-soft py-1" style="background-color: white;">
                            <div class="row justify-content-center">
                                <div class="col-12 text-center">
                                    <img src="<?php echo e(URL::asset('/assets/images/logo.png')); ?>" alt="Logo" class="img-fluid" style="max-width: 300px; height:100px">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lorenzotucceri/Progetti/ISEQL-project/resources/views/auth/register.blade.php ENDPATH**/ ?>