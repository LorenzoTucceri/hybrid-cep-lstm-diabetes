...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="Doctor" <?php if(\Session::has('updateUser') && Session::get('updateUser')->role->name == 'Doctor'): ?> selected <?php endif; ?>>Doctor</option>
                                </select>
                                ...
                                <tr>
                                    ...
                                    <td><ul class="list-unstyled hstack gap-1 mb-0">
                                            <li data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                <a href="<?php echo e(route('searchUser', $user->id)); ?>"  class="btn btn-sm btn-soft-warning"><i class="mdi mdi-pencil-outline  font-size-15"></i></a>
                                            </li>
        ...
        $(function() {
            var table = $('.yajra-datatable').DataTable({
                columns: [
                    ...
                    {
                        data: 'first_name', // Colonna First Name (Nome)
                        name: 'first_name'
                    },
                    {
                        data: 'last_name', // Colonna Last Name (Cognome)
                        name: 'last_name'
                    },
                    {
                        data: 'role', // Colonna Role (Ruolo)
                        name: 'role'
                    },
                    {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lorenzotucceri/Web/resources/views/userManagement.blade.php ENDPATH**/ ?>